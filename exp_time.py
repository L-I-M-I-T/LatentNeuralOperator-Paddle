...
if __name__ == "__main__":
    ...
    for i in range(arg.epoch):
        ...
        for data in tqdm(train_dataloader):
            ...
            for t in range(0, T):
                ...
                if t == 0:
                    ...
                    pred_full = paddle.concat((pred_full, pred_step), axis=-1)
                y1 = paddle.concat((y1[..., :arg.trunk_dim], y1[..., arg.trunk_dim+step:], gt), axis=-1)
            ...
            train_loss += loss_fn(pred_full, y2).item()
            ...
            for data in tqdm(val_dataloader):
                ...
                for t in range(0, T, step):
                    ...
                    if t == 0:
                        ...
                        pred_full = paddle.concat((pred_full, pred_step), axis=-1)
                    y1 = paddle.concat((y1[..., :arg.trunk_dim], y1[..., arg.trunk_dim+step:], pred_step), axis=-1)
                ...
                val_loss += loss_fn(pred_full, y2).item()
        ...
        if (i+1) % arg.checkpoint_epoch == 0:
            paddle.save("./experiments/{}/{}.pt".format(arg.exp_name, i+1))
