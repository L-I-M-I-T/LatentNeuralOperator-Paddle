...
We evaluate [Latent Neural Operator](https://arxiv.org/abs/2406.03923) with six widely used PDE forward problem benchmarks provided by [FNO and GeoFNO](https://github.com/neuraloperator/neuraloperator). Here we provide the Paddle version and the PyTorch version of the LNO code. Due to the inherent differences between the two frameworks, there may be some discrepancies in the precision results.
